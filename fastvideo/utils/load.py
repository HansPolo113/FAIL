...
from diffusers.models.transformers.transformer_flux import FluxTransformer2DModel, FluxTransformerBlock, \
    FluxSingleTransformerBlock
from diffusers.models.transformers.transformer_sd3 import SD3Transformer2DModel, JointTransformerBlock
...
def get_no_split_modules(transformer):
    # Support for UNet2DConditionModel (SD1.4)
    ...
    from fastvideo.models.flux_hf.transformer_flux import FluxTransformer2DModel as FluxTransformer2DModel_bf, \
        FluxSingleTransformerBlock as FluxSingleTransformerBlock_bf, FluxTransformerBlock as FluxTransformerBlock_bf
    ...
    elif isinstance(transformer, UNet2DConditionModel):
        # For SD1.4 UNet, we wrap at the block level for efficient FSDP
        return (CrossAttnDownBlock2D, CrossAttnUpBlock2D, UNetMidBlock2DCrossAttn)
    elif isinstance(transformer, FluxTransformer2DModel_bf):
        return (FluxSingleTransformerBlock_bf, FluxTransformerBlock_bf)
    else:
